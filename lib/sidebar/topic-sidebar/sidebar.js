...
class Sidebar extends view('appendable') {
  ...
  hide () {
    o('#topic-sidebar').addClass('hide');
  }

  show () {
    o('#topic-sidebar').removeClass('hide');
  }

  // Only needs to be defined in the situation where config.platforms is false and multiforum is true
  setforum (forum) {
    return;
  }
}
