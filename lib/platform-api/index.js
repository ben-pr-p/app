...
app.post('/platform/:id/vote', restrict, function (req, res) {
...
app.post('/platform/:id/unvote', restrict, function (req, res) {
...
app.post('/platform/:id/opine', restrict, hasAccess, function (req, res) {
