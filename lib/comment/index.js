...
app.get('/comment/all', function (req, res) {
  ...
  api.comment.comments({type: req.query.type, itemId: req.query.id, paging: paging}, function (err, comments) {
...
app.get('/comment/my-comments', restrict, function (req, res) {
  ...
  api.comment.all({type: req.query.type, itemId: req.query.id, userId: req.user.id}, function (err, comments) {
    if (err) return _handleError(err, req, res);
...
app.get('/comment/sidecomments', function (req, res) {
  ...
  log('Requesting sidecomments for %s %s', req.query.type, req.query.id);

  api.comment.all({type: req.query.type, itemId: req.query.id, context: 'paragraph'}, function (err, comments) {
    if (err) return _handleError(err, req, res);
