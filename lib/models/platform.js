...
var OpinionSchema = require('./opinion').OpinionSchema;
...
var PlatformSchema = new Schema({
  ...
  , opinions: [{ type: ObjectId, ref: 'Opinion'}]
...
PlatformSchema.methods.opine = function (opinion, cb) {
  this.unopine(opinion, function (err, platform) {
    if (err) {
...
PlatformSchema.methods.unopine = function (opinion, cb) {
  var opinions = this.opinions;

  var conflicts = opinions.filter(function(o) {
    return (o.topicId == opinion.topicId);
  });
