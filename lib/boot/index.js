...
app.use('/api', require('lib/platform-api'));

/**
 * Debate Room API Service
 */
app.use('/api', require('lib/debate-room-api'));
...
if (config.platforms) {
  app.use(require('lib/workspace'));
  app.use(require('lib/platform'));  
}

if (config.debateroom) {
  app.use(require('lib/debate-room'));
}
