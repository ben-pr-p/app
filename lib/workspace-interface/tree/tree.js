...
export default class PlatformTree extends Diagram {
  ...
  refresh (platforms = null, topics = null) {
    ...
    g.append('svg:circle')
      ...
      .attr('stroke', (d, i) => d.color || this.color(i))
      .attr('stroke-width', 2)
  ...
  onOptionClick (option) {
    ...
    this.getPlatform(this.startPlatform.id).then(p => {
      this.startPlatform.directOpinions = p.directOpinions;
      this.resetDragAndTip();
    })
  }
