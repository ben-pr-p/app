...
app.get(forumRouter('/admin/platforms'), require('lib/layout'));
app.get(forumRouter('/admin/platforms/create'), require('lib/layout'));
app.get(forumRouter('/admin/platforms/:id'), require('lib/layout'));
